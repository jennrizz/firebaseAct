package com.example.firbaselist
...
import com.example.firbaselist.adapter.arrayAdapter
import com.example.firbaselist.models.ytListTableHandler
        ...
        if (addBtn.text.toString() == "Add"){
            try {
                ...
                if (ytHandler.create(yt)) {
                    Toast.makeText(this,"YT Added", Toast.LENGTH_SHORT).show()
                    clearField()
                }
            }catch (e: Exception){
            ...
            try {
                ...
                if (ytHandler.edit(yt)) {
                    Toast.makeText(this, "YT Edited", Toast.LENGTH_LONG).show()
                    clearField()
                }
            }catch (e: Exception){
